...
export function emailLayout(
  ...
  const cta =
    ctaLabel && ctaUrl
      ? `<p style="margin:24px 0;"><a href="${escapeHtml(ctaUrl)}" style="background:#9d4f00;color:#fff;text-decoration:none;padding:12px 24px;border-radius:999px;font-weight:700;display:inline-block;">${escapeHtml(ctaLabel)}</a></p>`
      : "";
